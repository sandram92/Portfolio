...
import calculatorImage from "../public/assets/projects/calculator.png";
    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <Link
            href="https://calculator-app-sandram.netlify.app/"
            target="_blank"
          ...
          <Link
            href="https://github.com/sandram92/Calculator"
            target="_blank"
            rel="noopener noreferrer"
          >
